...
Touchscreen.prototype.swipe = async function(x1, y1, x2, y2, options = { duration: 500 }) {
  ...
  if(ui_view) {
    ...
    let dx1 = Math.floor(x1 * screen_viewport.deviceScaleFactor * (screen_viewport.deviceScaleFactor / device_viewport.deviceScaleFactor));
    let dy1 = Math.floor(y1 * screen_viewport.deviceScaleFactor * (screen_viewport.deviceScaleFactor / device_viewport.deviceScaleFactor));
    let dx2 = Math.floor(x2 * screen_viewport.deviceScaleFactor * (screen_viewport.deviceScaleFactor / device_viewport.deviceScaleFactor));
    let dy2 = Math.floor(y2 * screen_viewport.deviceScaleFactor * (screen_viewport.deviceScaleFactor / device_viewport.deviceScaleFactor));
