          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 2;
                _context2.next = 5;
                return (0, _requestPromise2.default)({ method: 'GET', uri: this.url_stop, json: true });
              ...
              case 11:
                ...
                throw new Error('uiautomator-server: Failed to stop uiautomator json-prc server on device ' + (_context2.t0.message || _context2.t0));
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                _context3.next = 6;
                return (0, _requestPromise2.default)({ method: 'POST', uri: this.url_json, body: props, json: true });
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                resp = _context4.sent;
                return _context4.abrupt('return', _lodash2.default.eq(resp && resp.result, 'pong'));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 7:
                ...
                _context6.next = 10;
                return client.install(serial, _path2.default.resolve(__dirname, '../src/com.github.uiautomator.apk'));
              ...
              case 15:
                ...
                _context6.next = 18;
                return client.install(serial, _path2.default.resolve(__dirname, '../src/com.github.uiautomator.test.apk'));
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                serial = this.serial;
                _context9.next = 4;
                return client.shell(serial, 'am instrument -w com.github.uiautomator.test/android.support.test.runner.AndroidJUnitRunner');
...
_client2.default.prototype.uiautomator = function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(serial, options) {
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            return _context10.abrupt('return', this.__ui = this.__ui || new UIAutomator(this, _lodash2.default.assign({ serial: serial }, options)));
