        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                return _context3.abrupt('return', _requestPromise2.default.post(this.url_json, { json: props }));
    ...
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            uiautomator = new UIAutomator(this, _lodash2.default.assign({ serial: serial }, options));
            return _context10.abrupt('return', uiautomator.connect());
