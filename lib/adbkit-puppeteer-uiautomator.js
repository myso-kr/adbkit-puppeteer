          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                this.handler = _childProcess2.default.spawn('adb -s ' + serial + ' shell am instrument -w com.github.uiautomator.test/android.support.test.runner.AndroidJUnitRunner');
