...
_Input.Touchscreen.prototype.swipeDirection = function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(direction) {
    ...
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : { duration: 300 };
                  ...
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      return _this.executionContext().evaluate(function (el) {
                        ...
                        var boundingB = bounding.top <= (window.innerHeight || document.documentElement.clientHeight);
                        var boundingR = bounding.left <= (window.innerWidth || document.documentElement.clientWidth);
