      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 9;
            return client.shellWait(serial, 'uiautomator dump').delay(3000);

          case 9:
            _context.next = 11;
            return client.shellWait(serial, 'cat /sdcard/window_dump.xml');

          case 11:
            ui_dump = _context.sent.toString().trim();
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            ui_dump = _context2.sent.toString().trim();
            ui_view = _lodash2.default.findDeep(_fastXmlParser2.default.parse(ui_dump, XML_OPTIONS), { class: "android.webkit.WebView" });
