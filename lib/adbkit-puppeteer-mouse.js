      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            dx = Math.floor(x * Math.min(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dy = Math.floor(y * Math.min(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            console.log('pos', { x1: x1, y1: y1, x2: x2, y2: y2 });
            console.log('rect', ui_rect);

            dx1 = Math.floor(x1 * Math.min(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dy1 = Math.floor(y1 * Math.min(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dx2 = Math.floor(x2 * Math.min(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dy2 = Math.floor(y2 * Math.min(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));


            console.log('pos', { dx1: dx1, dy1: dy1, dx2: dx2, dy2: dy2 });
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt('return', _bluebird2.default.resolve().then(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
              var client, serial, screen_viewport, el_hide, el_rect;
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 5:
                      ...
                      _context4.next = _context4.t0 === 'boundingT' ? 10 : _context4.t0 === 'boundingL' ? 14 : _context4.t0 === 'boundingB' ? 18 : _context4.t0 === 'boundingR' ? 22 : 26;
                      break;
