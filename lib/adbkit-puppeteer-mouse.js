      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            dx = Math.floor(x * Math.max(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dy = Math.floor(y * Math.max(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            dx1 = Math.floor(x1 * Math.max(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dy1 = Math.floor(y1 * Math.max(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dx2 = Math.floor(x2 * Math.max(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
            dy2 = Math.floor(y2 * Math.max(screen_viewport.deviceScaleFactor, device_viewport.deviceScaleFactor));
