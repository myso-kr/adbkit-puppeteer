...
require('./adbkit-puppeteer-uiautomator');

require('./adbkit-puppeteer-bridge');

require('./adbkit-puppeteer-evaluate-on-new-document');
...
require('./adbkit-puppeteer-viewport');
...
_client2.default.prototype.puppeteer = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(serial, options) {
    ...
    var opts, CHROME_PACKAGES, CHROME_ACTIVITY, CHROME_PROTOCOL, chromeCommandLine, chrome;
